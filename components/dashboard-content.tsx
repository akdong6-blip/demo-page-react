    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4">
          ...
          <select className="px-3 md:px-4 py-2 bg-card border border-border rounded-lg text-xs md:text-sm">
            <option>최근 7일</option>
      ...
      {/* Cost Summary */}
      <CostSummary industry={selectedIndustry} />

      {/* Electricity Rate Selector and Cost Calculator */}
      <Card>
        <CardHeader>
